        ...
        <div className="relative" ref={exportButtonRef}>
          ...
          {showExportDropdown && (
            <div 
              ...
              className="absolute right-0 top-full mt-1 w-52 bg-[var(--card)] border border-[var(--border)] shadow-lg rounded-md z-50 py-1 animate-fadeIn"
            >
              <button 
                onClick={() => handleExportOptionClick('jsx')}
                className="flex items-center gap-2 w-full px-4 py-2 text-left hover:bg-[var(--secondary)] cursor-pointer transition-colors"
              >
                  <div className="flex items-center gap-2">
            ...
            {components.length === 0 ? (
                ...
                >
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-white">Build with AI</span>
